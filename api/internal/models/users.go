...
var UserRels = struct {
	...
	UseridScores: "UseridScores",
}

// userR is where relationships are stored.
type userR struct {
	UseridScores ScoreSlice `boil:"UseridScores" json:"UseridScores" toml:"UseridScores" yaml:"UseridScores"`
}
...
func (r *userR) GetUseridScores() ScoreSlice {
	if r == nil {
		return nil
	}
	return r.UseridScores
}
...
// UseridScores retrieves all the score's Scores with an executor via userid column.
func (o *User) UseridScores(mods ...qm.QueryMod) scoreQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"scores\".\"userid\"=?", o.ID),
	)

	return Scores(queryMods...)
}

// LoadUseridScores allows an eager lookup of values, cached into the
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (userL) LoadUseridScores(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	var slice []*User
	var object *User
	...
	query := NewQuery(
		qm.From(`scores`),
		qm.WhereIn(`scores.userid in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
	...
	if singular {
		object.R.UseridScores = resultSlice
	...
	for _, foreign := range resultSlice {
		for _, local := range slice {
			if local.ID == foreign.Userid {
				local.R.UseridScores = append(local.R.UseridScores, foreign)
				if foreign.R == nil {
					foreign.R = &scoreR{}
				}
...
// AddUseridScores adds the given related objects to the existing relationships
// of the user, optionally inserting them as new records.
// Appends related to o.R.UseridScores.
// Sets related.R.UseridUser appropriately.
func (o *User) AddUseridScores(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Score) error {
	var err error
	...
	if o.R == nil {
		o.R = &userR{
			UseridScores: related,
		}
	} else {
		o.R.UseridScores = append(o.R.UseridScores, related...)
	}
