...
Game.Render = function (context, snake) {
  ...
  this.drawCell = function (x, y) {
    ...
    context.beginPath();
    context.arc(
      x * snake.stage.config.cw + 6,
      y * snake.stage.config.cw + 6,
      4,
      0,
      2 * Math.PI,
      false
  ...
  this.collision = function (nx, ny) {
    if (
      nx == -1 ||
      nx == snake.stage.width / snake.stage.config.cw ||
      ny == -1 ||
      ny == snake.stage.height / snake.stage.config.cw
    ) {
      return true;
    }
    return false;
